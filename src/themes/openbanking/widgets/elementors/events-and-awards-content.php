        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
					...
					'previous' => esc_html__( 'Previous', 'plugin-name' ),
					'upcoming' => esc_html__( 'Upcoming', 'plugin-name' ),
				],
                'default' => 'default',
            ]
        );
...
//		$this->add_inline_editing_attributes( 'content', 'advanced' );
        ?>
            <div class="wrapper-blog-article" id="example-<?php echo $settings['type']; ?>">
                <input type="hidden" id="site_url" value="<?= site_url() ?>"/>
                <div class="wrapper">
                    <h3></h3>
                    <?php if(isset($settings['type']) && $settings['type'] != 'default') : ?>
                        <div class="wrapper-previous">
                        <h2 class="heading-previous"><?php echo $settings['type'] == 'upcoming' ? 'Upcoming Events' : 'Previous Events'; ?></h2>
                        </div>
                    <?php endif; ?>
                    <div class="wrapper-filter">
                        <form class="form-control-inline" @submit="search">
                            <input class="search-input" type="text" name="search" placeholder="Search events" v-model="search">
                        ...
                        <div class="wrapper-option-mobile">
                            <button class="btn filter-mobile-<?php echo $settings['type']; ?>">
                                Filter
            ...
            <script>
                var vm = new Vue({
                    el: '#example-<?php echo $settings['type']; ?>',
                    data: function () {
                        return {
                            listBlogs: [],
                            listSort: [],
                ...
                $('.filter-mobile-<?php echo $settings['type']; ?>').click(function () {
