<?php
class Elementor_BrazilCampfire_Widget extends \Elementor\Widget_Base
{
    public function get_title()
    {
        return 'BrazilCampfire';
    }
            ...
            [
                ...
                'default' => __("
                                <h2 class='title-campfire --reveal --trigger'>
                                    Red-hot-relevant debates
                                </h2>
                                <div class='content-campfire text-20-light --fade-in'>
                                    Sessions and insights designed to inspire, educate and ignite sector growth.
                                </div>
                                <div class='wrapper-action-campfire'>
                                    <a class='btn btn-primary btn-register-campfire' href='/campfires'>See All Campfires</a>
                                    <a class='see-all-campfire link' ndata-fancybox='video' id='single_image' href='#' data-src='https://www.youtube.com/watch?v=B3PZqcxnjt8'>What's an OBE Campfire</a>
                                </div>
                                ", 'plugin-name'),
            ]
        );
