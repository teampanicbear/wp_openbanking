...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="wrapper-content">
                <div class="wrapper-video-mission">
                    <div class="video-mission">
                        <?php
                        if (get_post_meta(get_the_ID(), 'advanced_options_partner_video', true) != "") {
                        ?>
                            <img class="thumbnail" src="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_poster-video', true) ?>" alt="">
                            <a ndata-fancybox="video" id="single_image" href="#" data-src="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_video', true) ?>">
                ...
                <div class="wrapper-content-title">
                    ...
                    <div class="banner-show-info">
                        <div class="info-left text-16-normal">
                            ...
                            <a href="#" class="sign-link"><?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_location', true) ?></a>
                        </div>
                    </div>
                    ...
                    <div class="banner-action">
                        <div class="arrow-action link-action">
                            <a href="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_url-partner', true) ?>" class=" link">Visit website</a>
                            <div class="wrapper-img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/navi_benefit.svg" alt="">
                            </div>
                        </div>
                        <div class="link-icon">
                            <a href="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_linkedin', true) ?>">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/linkedin.svg" alt="">
                            </a>
                            <a href="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_facebook', true) ?>">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/fb.svg" alt="">
                            </a>
                            <a href="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_twitter', true) ?>">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vector.svg" alt="">
                            </a>
                            <a href="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_instagram', true) ?>">
    ...
    <div class="strategic-partner-container wrapper-sponsor-other">
        <div class="wrapper">
            <div class="partner-content">
                ...
                <h2>Other Strategic Partners</h2>
                    ...
                    <div class="sponsor-content">
                        ...
                        <?php if ($the_query->have_posts()) : ?>
                            <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
                                <div class="sponsor-avatar sponsor-other" data-title="<?php the_title(); ?>" data-content="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_description', true) ?>">
                    ...
                    <div class="sponsor-content">
                        ...
                        <?php if ($the_query->have_posts()) : ?>
                            <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
                                ...
                                ?>
                                <div class="sponsor-avatar" data-title="<?php the_title(); ?>" data-content="<?php echo get_post_meta(get_the_ID(), 'advanced_options_partner_description', true) ?>">
